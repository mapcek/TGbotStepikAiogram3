...
async def send_piza(message: Message):
    gotovim = (
        'https://sun6-21.userapi.com/impg'
        '/B50N47WBDqHoeLJxxC0EdGriePv1F0iyZRVedw/'
        '_2S3EhrjouI.jpg?size=1280x954&quality=96&'
        'sign=17d1f08a47481b2f059e9d65420720e8&'
        'c_uniq_tag=KrFFKdZWnVPSx6tZ4W1s9ALFNa2Tk9Vc5LkyixCV0UI&type=album'
    )
    piza = (
        'https://sun9-53.userapi.com/impf'
        '/WVkxqJdoFwn1YSleLs4PXM8WA6IopsaGhGJjYQ'
        '/g7FvT6vQYyw.jpg?size=640x800&quality=96&'
        'sign=41e235670272a803abe138255128ab40&'
        'c_uniq_tag=QSL5K5xjRii4k4GgoV153TpUqw5SGE_RtZJ4OuGkiEo&type=none'
    )
...
async def weather_command(message: Message):
    await message.answer(
        'Что бы узнать текущую погоду, '
        'пришлите свою геолокацию.'
        )
...
async def send_weather(message: Message):
    ...
    await message.answer(
        ...
        f'{weather.wind_dir} ветер '
        f'со скоростью {weather.wind_mps} метров в секунду\n'
    )
